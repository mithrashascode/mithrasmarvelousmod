...
public class ModItems {
    ...
    public static final Item FRUIT_SALAD = registerItem("fruit_salad", properties -> new Item(properties
            .food(ModFoods.FRUIT_SALAD, ModFoods.FRUIT_SALAD_CONSUMABLE)));
